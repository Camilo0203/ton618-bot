...
const command = createHelpCommand({
  ...
  descriptionLocalizations: {
    ...
    "es-ES": "Centro de ayuda interactivo con los comandos disponibles en este servidor",
    "es-419": "Centro de ayuda interactivo con los comandos disponibles en este servidor",
  },
  audience: "user",
});
